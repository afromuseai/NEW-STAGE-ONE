        ...
        <AnimatePresence mode="wait">
          {!showWebsite ? (
            ...
            <motion.div key="website" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
              <div className="mb-4">
                <button onClick={() => setShowWebsite(false)} className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  ← Back to Analysis
                </button>
              </div>
              <WebsitePanel
                businessIdea={results ? "" : ""}
    ...
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <div className="flex flex-1 flex-col min-w-0 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto">
          <AnimatePresence mode="wait">
            {tabFromSearch === "new" ? (
              <motion.div key="new" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex flex-col h-full">
                {renderNew()}
              </motion.div>
